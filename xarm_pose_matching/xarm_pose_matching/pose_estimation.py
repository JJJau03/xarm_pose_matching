...
depth_image_path = "/home/brad/dev_ws/src/xarm_pose_matching/xarm_pose_matching/images/data/depth/00400.png"
...
class PoseEstimator():
    def __init__(self):
        ...
        self.ply = o3d.io.read_point_cloud(model_path) 
        self.rgb_image = None
    ...
    def statistic_graph(self):
        ...
        plt.title("Evolución de la profundidad en el tiempo")
        plt.legend()
        plt.grid(True)
        plt.tight_layout()
        plt.show()
